const rawData = [
    ...
    {id:"Suresvara", label:"Sureśvara", year:800, school:"Advaita", region:"South", work:"Naishkarmya Siddhi", others:["Brihadaranyaka Vartika"], note:"Direct disciple; first acharya of Sringeri matha; defended Advaita."},
    {id:"Padmapada", label:"Padmapāda", year:800, school:"Advaita", region:"East", work:"Panchapadika", others:[], note:"Direct disciple; founder of Vivarana sub-school; linked to Puri matha."},
    {id:"Hastamalaka", label:"Hastāmalaka", year:800, school:"Advaita", region:"West", work:"", others:[], note:"Direct disciple; profound simple teachings on self-knowledge."},
    {id:"Totaka", label:"Toṭakācārya", year:800, school:"Advaita", region:"North", work:"Toṭakāṣṭakam", others:[], note:"Direct disciple; linked to Jyotirmath; devotional hymns."},
    {id:"Vacaspati", label:"Vācaspati Miśra", year:900, school:"Advaita", region:"East", subregion:"Mithila", work:"Bhāmatī", others:["Nyaya Tatparya Tika"], note:"Founder of Bhamati sub-school; polymath commentator on Shankara."},
    {id:"Sarvajnatman", label:"Sarvajñātman", year:900, school:"Advaita", region:"South", work:"Saṃkṣepa Śārīraka", others:[], note:"Post-Shankara scholar; summarized Brahma Sutras in Advaita framework."},
    ...
    {id:"Madhusudana", label:"Madhusūdana Sarasvatī", year:1540, school:"Advaita", region:"East", subregion:"Bengal", work:"Advaita Siddhi", others:["Bhakti-rasāyana"], note:"Defended Advaita against Dvaita; integrated bhakti."},
    {id:"Appayya", label:"Appayya Dīkṣita", year:1520, school:"Advaita", region:"South", subregion:"Tamil Nadu", work:"Siddhāntaleśa Saṅgraha", others:["Kuvalayānanda"], note:"Polymath; reconciled Shaiva Siddhanta with Advaita."},
    {id:"DharmarajaAdhvarindra", label:"Dharmarāja Adhvarīndra", year:1600, school:"Advaita", region:"South", work:"Vedānta Paribhāṣā", others:[], note:"Standard epistemology text; pramāṇas in Advaita."},
    {id:"Nrisimhashrama", label:"Nṛsiṃhāśrama", year:1550, school:"Advaita", region:"South", work:"", others:["Commentaries on Advaita texts"], note:"Bridged classical and later Advaita; key commentator."},
    ...
    {id:"Sacchidanandendra", label:"Sacchidānandendra Sarasvatī", year:1880, school:"Advaita", region:"South", work:"Vedānta Prakriyā Pratyabhijñā", others:[], note:"Reformer; emphasized pure Shankara over sub-schools."},
    {id:"RamanaMaharshi", label:"Ramana Maharshi", year:1879, school:"Advaita", region:"South", subregion:"Tamil Nadu", work:"Upadeśa Sāram", others:["Nāṉ Yār? (Who Am I?)"], note:"Self-inquiry (ātma-vicāra); direct non-dual realization."},
